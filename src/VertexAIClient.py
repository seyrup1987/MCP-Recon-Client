...
from VertexAIModels import Models, Plan, ToolStep # Import Plan and ToolStep
...
class MCPClient:
    ...
    async def _invoke_llm(self, messages: List[Any], request_structured_output: bool = False, output_schema=None) -> Any:
        ...
        try:
             if request_structured_output:
                 ...
                 response = await self.models.invoke_prompt(messages)
    ...
    async def _execute_plan(self, ai_plan: Plan, executed_tool_calls: set) -> str:
        ...
        try:
            ...
            self._truncate_history()
            try:
                 final_response_obj = await self._invoke_llm(self.conversation_history)
